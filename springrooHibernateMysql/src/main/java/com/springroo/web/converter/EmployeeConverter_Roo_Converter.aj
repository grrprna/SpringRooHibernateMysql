...
package com.springroo.web.converter;

import com.springroo.jpa.data.Employee;
import com.springroo.web.converter.EmployeeConverter;
...
privileged aspect EmployeeConverter_Roo_Converter {
    ...
    declare @type: EmployeeConverter: @FacesConverter("com.springroo.web.converter.EmployeeConverter");
